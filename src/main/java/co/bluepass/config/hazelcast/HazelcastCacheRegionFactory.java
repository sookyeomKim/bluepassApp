package co.bluepass.config.hazelcast;
...
import co.bluepass.config.CacheConfiguration;
...
/**
 * The type Hazelcast cache region factory.
 */
public class HazelcastCacheRegionFactory implements RegionFactory {
    ...
    /**
     * Instantiates a new Hazelcast cache region factory.
     */
