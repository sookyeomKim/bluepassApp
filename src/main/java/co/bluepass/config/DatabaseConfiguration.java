 ...
 */
@Configuration
@EnableJpaRepositories("co.bluepass.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "co.bluepass.config.HerokuDatabaseConfiguration")
    ...
    /**
     * Hibernate 4 module hibernate 4 module.
     *
     * @return the hibernate 4 module
     */
    @Bean
